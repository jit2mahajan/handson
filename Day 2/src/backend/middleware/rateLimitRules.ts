 ...
 */
export const createRecordRateLimitConfig: RateLimitConfig = {
  windowMs: 60 * 1000, // 1 minute
  max: 50,
 ...
 */
export const reportRateLimitConfig: RateLimitConfig = {
  windowMs: 60 * 1000, // 1 minute
  max: 5,
 ...
 */
export const auditExportRateLimitConfig: RateLimitConfig = {
  windowMs: 60 * 1000, // 1 minute
  max: 3,
 ...
 */
export const approvalRateLimitConfig: RateLimitConfig = {
  windowMs: 60 * 1000, // 1 minute
  max: 10,
...
export function shouldSkipRateLimit(req: Request): boolean {
  ...
  return (req as any).internal === true;
}
